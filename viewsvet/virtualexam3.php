         ...
         <li>
             <a href="javascript:void();" style="width: 100%;" class="container p-3">
                <div class="d-flex justify-content-between">
                    <label class="" style="position: relative;top: 8px; font-size: 15px;">Opción1 desplegable</label>
          ...
          <ul>
           ...
           <li style="padding-top: 10px; width: 80%; position: relative; left: 30px;">
            <a href="javascript:void();">
              ...
              <ul class="p-2">
               <li class="p-1"><input type="checkbox" class="form-check-input" value=""> Seleccion</li>
               <li class="p-1"><input type="checkbox" class="form-check-input" value=""> Seleccion</li>
               <li class="p-1"><input type="checkbox" class="form-check-input" value=""> Seleccion</li>
               <li class="p-1"><input type="checkbox" class="form-check-input" value=""> Seleccion</li>                           
              </ul>
