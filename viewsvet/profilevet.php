...
<!-- BUTTON VIDEL CALL AND MESSAGE -->
<!-- BUTTON VIDEL CALL AND MESSAGE -->
<!-- BUTTON VIDEL CALL AND MESSAGE -->

      <div class="p-3 mb-3 row justify-content-center">
          <a href="#" id="firstbutton" class="btn btn-md p-2"><img src="../img/chat-left-text.svg" alt="" width="20"> Message</a>
      </div>
...
<div class="container mb-3 p-1" id="profilevetborder">
        <div class="profilecontent">
                  ...
                  <div class="d-flex justify-content-start p-2">
                    <p style="text-align:justify;">Dr. Amanda Sara is a general equire vet with specializations in animale health. She has been practicing veterinary medicine for 14 years, 
                      fueled by passion to help animals. Internal medicine specialy includes cardiology, neurology and oncology.</p>
                  </div>  
        </div>               
</div>
