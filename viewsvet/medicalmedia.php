        ...
        <div class="row d-flex align-items-center p-2 mb-2" style="width: 100%; position: relative; left: 6px;">
          <div class="container d-flex justify-content-between">
            <div class="d-flex p-2 bd-highlight">
             ...
             <div class="d-flex p-2 bd-highlight">
                <h4 class="firstcolor"> Medical Media</h4>
             </div>
...
<!-- BUTTOM UPLOAD MEDICAL DOCUMENT -->
        ...
        <div class="row container d-flex justify-content-between">
                    <div class="d-flex p-2 bd-highlight col-md-12">
                            <a href="" class="btn btn-md" id="firstbutton" data-bs-toggle="modal" data-bs-target="#uploadmedicalmedia" data-bs-whatever="@mdo" style="width: 100%;">
...
<!-- RESULTS EXAMPLE VIRTUAL -->
        ...
        <div class="row d-flex align-items-center p-3">
              <h4 class="firstcolor">July 2022</h4>
        </div>
...
<!-- RESULTS EXAMPLE VIRTUAL -->
        ...
        <div class="row d-flex align-items-center p-3">
              <h4 class="firstcolor">Aug 2022</h4>
        </div>
...
<!-- SLIDER MEDICAL MEDIA -->
              ...
              <div class="col-md-12 mb-2 p-2">
                <section id="medical-media2" class="splide d-flex align-items-center justify-content-center" aria-label="The carousel with thumbnails. Selecting a thumbnail will change the Beautiful Gallery carousel.">
                  <div class="splide__track">
                    <ul class="splide__list">
                      <li class="splide__slide">
                        <img src="../img/xray1.jpg" class="rounded-4">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> <img src="../img/equivetcare.png" class="img-responsive" id="logo"><br> Search media by a date range</h5>
...
<!--MODAL UPLOAD MEDICAL MEDIA -->
<!--MODAL UPLOAD MEDICAL MEDIA -->
<!--MODAL UPLOAD MEDICAL MEDIA -->

<div class="modal fade" id="uploadmedicalmedia" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> <img src="../img/equivetcare.png" class="img-responsive" id="logo"><br> Upload Medical Media</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form>
                    <div class="container col-md-12 p-2">
                      <div class="form-group" x-data="{ fileName: '' }">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control form-control-md" placeholder="Upload Medical Media" x-model="fileName">
          ...
          <div class="modal-footer col-md-12 justify-content-center">
            <button type="button" class="btn btn-md col-md-12" id="firstbutton">Submit</button>
          </div>
